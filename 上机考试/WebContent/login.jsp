				...
				<div class="controls w3l">
					...
					<div class="stage" style="text-align: center;">
							...
							<div id="s_form" class="cbImage active signin agileits">
								<h3>学生</h3>
								<form action="login" method="post"  class="form">
									<input name="uname" required type="text" placeholder="学号" value="2212080179">
									<input name="pwd" required type="text" placeholder="姓名" value="方新宇" >
					...
					<div class="clear"></div>
					<div class="footer">
						<p>&copy; 2024 design by Henu students</p>
					</div>
